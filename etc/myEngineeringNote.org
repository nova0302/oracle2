...
*** web.xml에 서블릿 맵핑
    ...
    - 기존경로 http://localhost:8090/helloServlet/com.javalec.ex.Helloservlet
    - URL 맵핑경로 http://localhost:8090/helloservlet/HServlet
...
<servlet-class> com.javalec.ex.HelloServlet </servlet-class>
</servlet>
